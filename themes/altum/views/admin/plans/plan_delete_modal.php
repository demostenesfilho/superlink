            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="modal-title">
                        ...
                        <?= $this->language->admin_plan_delete_modal->header ?>
                    </h5>
                ...
                <p class="text-muted"><?= $this->language->admin_plan_delete_modal->subheader ?></p>

                <div class="mt-4">
                    <a href="" id="plan_delete_modal_url" class="btn btn-lg btn-block btn-danger"><?= $this->language->global->delete ?></a>
                </div>
            </div>
